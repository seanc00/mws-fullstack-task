...
<div class="login-block">
    ...
    <div class="desktop-side-aesthetic-left-side">
        <img class="desktop-logo" src="/resources/assets/mws-logo-white.png" alt="white mws logo and icon">
        <div class="desktop-copyright">
            Copyright © 2026 MWS LTD. Designed By <a href="#">Maxweb</a>
        </div>
        <img class="desktop-bg-img" src="/resources/assets/login-bg.png" alt="decorative background">
    </div>
    ...
    <div class="form-cont">
        ...
        <form action="" method="post">
            ...
            <div class="forgot-password-cont">
        ...
        <div class="quick-sign-in-links-cont">
            ...
            <a href="#">
                <svg class="apple-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-apple" viewBox="0 0 16 16">
